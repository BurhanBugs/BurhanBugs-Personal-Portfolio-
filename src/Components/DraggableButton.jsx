            ...
            <div className="fixed top-[3%] right-[4%]">
                <div className="relative">
                    <motion.button ref={buttonRef}
                        onClick={handleClick}
                        className={`p-2 animate-bounce bg-[#FFB400] flex justify-center items-center text-white rounded-full shadow-lg focus:outline-none transition-all ${showOptions ? 'h-32 w-32' : 'h-12 w-12'
                            }`}
                    ...
                    {showOptions && (
                        <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-4 flex flex-wrap justify-center gap-4">
                            <motion.div 
                                ...
                                className="flex  items-center justify-center w-12 h-12 p-1 rounded-full bg-[#FFB400] shadow-md cursor-pointer hover:bg-yellow-500"
                            >
                                <lord-icon
